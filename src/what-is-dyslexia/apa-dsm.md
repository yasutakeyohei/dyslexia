...
歴史的に日本では精神障害という言葉に強い差別と偏見を持つ方が多くいます。これを[社会的スティグマ](https://ja.wikipedia.org/wiki/%E7%A4%BE%E4%BC%9A%E7%9A%84%E3%82%B9%E3%83%86%E3%82%A3%E3%82%B0%E3%83%9E)と言うようですが、負のイメージがついてしまった用語はなかなか変えられません。私は、差別や偏見の原因は、便宜上の理由から「精神障害」という単語でさまざまな症状をまとめてしまっていることにあると考えています。

精神障害に分類されているさまざまな状況は、生物学上の原因が明らかでないものばかりであり、お互いの関連性も原理的には定義できないものです。しかし、統計や診断を行う必要性から、さまざまな状況をまとめるための用語が必要になります。そのようにして考案された便宜上の用語が、単純化され、ひとり歩きし、一般社会で何らかの意味を持つようになるという状況は良くあります。この「精神障害」も、その最たる例と考えられます。

ですので、普段の生活においては「精神障害」という分類上の用語は忘れ、可能な限り細分化した名称（ディスレクシアなど）を使うことが理想的です。つまり、関係が分からないものと一緒にせず、ディスレクシアはディスレクシアとして捉えようということです。そのディスレクシア自体も、便宜上の用語であることには違いはありません。さまざまな状況があり、さまざまに対応が必要です。
