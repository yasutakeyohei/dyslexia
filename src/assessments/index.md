...
教育委員会は、SDGsの「誰一人取り残さない（no one left behind）」という言葉をよく使います。しかし私はこの言葉が好きではありません。「取り残されるような場所がある」という差別的な発想を感じるからです。私は「見ていながら気づかない＝見過ごす」の否定形である「見過ごさない」という表現の方がよいように思います。そのため、ここでは「だれも見過ごさない」という表現を使います。
